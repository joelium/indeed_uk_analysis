---
title: "Code snippets"
subtitle: "Code for web scraping that didn't work"
author: "Joel Leaman"
date: 04-09-2023
data-modified: 04-09-2023
...
get_search_results(test_search_term)
```


## Test webscrape 2 - httpx
403 response
...
test_scrape(test_search_term)
```


## Test webscrape 3 - httpx with cookies
Cloudflare "challenge" page, asking for JavaScript and cookie support
